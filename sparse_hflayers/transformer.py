...
class SparseHopfieldEncoderLayer(Module):
    ...
    def __init__(self,
        ...
        """
        super(SparseHopfieldEncoderLayer, self).__init__()
...
class SparseHopfieldDecoderLayer(Module):
    """
    Module with underlying Hopfield associations to be used as a decoder in transformer-like architectures.
    """

    def __init__(self,
                 hopfield_association_self: SparseHopfield,
                 hopfield_association_cross: SparseHopfield,
                 dim_feedforward: int = 2048,
                 dropout: float = 0.1,
                 activation: str = r'relu'
                 ):
        ...
        :param activation: activation to be applied on the result of the internal linear projections
        """
        super(SparseHopfieldDecoderLayer, self).__init__()
