...
class SparseHopfield(Module):
    ...
    def __init__(self,
        ...
        """
        super(SparseHopfield, self).__init__()
...
class SparseHopfieldPooling(Module):
    """
    ...
    def __init__(self,
        ...
        """
        super(SparseHopfieldPooling, self).__init__()
        self.hopfield = SparseHopfield(
...
class SparseHopfieldLayer(Module):
    """
    ...
    def __init__(self,
        ...
        """
        super(SparseHopfieldLayer, self).__init__()
        self.hopfield = SparseHopfield(
            input_size=input_size, hidden_size=hidden_size, output_size=output_size, pattern_size=pattern_size,
            num_heads=num_heads, scaling=scaling, update_steps_max=update_steps_max, update_steps_eps=update_steps_eps,
            normalize_stored_pattern=normalize_stored_pattern,
